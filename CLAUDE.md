...
```bash
npm test                          # Run all 308 tests (vitest)
...
```bash
npm run dev:cli -- <command>       # CLI: init, study, stats, calibration, decks, cards, topics, import, export, embeddings
